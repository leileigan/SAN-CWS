...
class ScaledDotProductAttention(nn.Module):
    ...
    def __init__(self, use_window, hidden_size, num_heads, attention_dropout=0.1):
...
class MultiHeadAttention(nn.Module):
    ...
    def __init__(self, use_window, hidden_size, num_heads, attention_dropout=0.1, share=True):
        ...
        self.attention = ScaledDotProductAttention(use_window, hidden_size, num_heads, attention_dropout)
...
class EncoderBlock(nn.Module):
    ...
    def __init__(self, use_window, hidden_size, num_heads, inner_linear, attention_dropout,
        ...
        self.self_attention = MultiHeadAttention(use_window, hidden_size, num_heads, attention_dropout, share=True)
...
class TransformerEncoder(nn.Module):
    ...
    def __init__(self, data, context_size=250, hidden_size=512, num_layers=2, num_heads=8, inner_linear=2048,
        ...
        print("use window: ", data.use_window)
